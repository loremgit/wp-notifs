...
if ( function_exists( 'wnbell_fs' ) ) {
    wnbell_fs()->set_basename( false, __FILE__ );
} else {
    ...
    if ( !function_exists( 'wnbell_fs' ) ) {
        ...
        function wnbell_fs() {
            ...
            if ( !isset( $wnbell_fs ) ) {
                ...
                $wnbell_fs = fs_dynamic_init( array(
                    'id'             => '7859',
    ...
    function wnbell_custom_is_submenu_visible(  $is_visible, $menu_id  ) {
        ...
        return wnbell_fs()->can_use_premium_code();
    }

    wnbell_fs()->add_filter(
        'is_submenu_visible',
    ...
    add_action( 'init', 'wnbell_plugin_init' );
    wnbell_fs()->add_action( 'after_uninstall', 'wnbell_fs_uninstall_cleanup' );
    function wnbell_fs_uninstall_cleanup() {
